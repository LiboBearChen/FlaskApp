...
let exampleArray = [
  ...
  [
    {
      repo: "FlaskApp",
      path: "blog/blueprints/page/templates/page/index.html",
    },
    {
      repo: "FlaskApp",
      path: "blog/blueprints/page/templates/page/projects.html",
    },
  ],
...
function fetchData(exampleIndex, examplePage, callback1, callback2) {
  $("#fetchContainer").html(
    "<h3 style='text-align:center;'>Fetching data from Github...<br><br><p><i class='fa fa-spinner w3-spin' style='font-size:200px'></i></p></h3>"
  );
...
function displayer(value, examplePage, exampleIndex) {
  ...
  $("#repo").html(
    `   From Github Repository: <a target="_blank" href=${repoLink}>${repoName}</a>`
  );
}
...
$(document).ready(function () {
  ...
  $("#next").click(function () {
    if (
      examplePage > -1 &&
      examplePage < exampleArray[exampleIndex].length - 1
    ) {
      examplePage++;
      fetchData(exampleIndex, examplePage, markCode, displayer);
    }
